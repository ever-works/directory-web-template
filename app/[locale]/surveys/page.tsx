						...
						{publishedSurveys.map((survey) => (
							...
							>
								<div className="flex items-start justify-between mb-3">
									...
									<span
										className={`px-2 py-1 rounded-sm text-xs font-medium ${getTypeColor(survey.type)}`}
									>
										{survey.type}
									</span>
								</div>
								...
								<div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-4">
									<span
										className={`px-2 py-1 rounded-sm text-xs font-medium ${getStatusColor(survey.status)}`}
									>
										{survey.status}
									</span>
								</div>
