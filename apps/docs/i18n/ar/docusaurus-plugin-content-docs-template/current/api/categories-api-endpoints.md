...
title: الفئات نقاط نهاية واجهة برمجة التطبيقات
sidebar_label: الفئات API
sidebar_position: 56
---

# الفئات نقاط نهاية واجهة برمجة التطبيقات

توفر واجهة برمجة التطبيقات للفئات نقطة نهاية عامة للتحقق من وجود أي فئات في نظام المحتوى. يتم الحصول على الفئات من مستودع محتوى CMS المستند إلى Git وتمثل التصنيف عالي المستوى لتنظيم العناصر.

**المصدر:** `template/app/api/categories/exists/route.ts`
