...
title: "نقاط نهاية واجهة برمجة التطبيقات للفئة"
sidebar_label: "الفئات"
sidebar_position: 10
---

# نقاط نهاية واجهة برمجة التطبيقات للفئة

توفر واجهة برمجة التطبيقات للفئات نقطة نهاية عامة خفيفة الوزن للتحقق من وجود الفئات في النظام. يتم اشتقاق الفئات من طبقة المحتوى (CMS المستندة إلى Git) بدلاً من قاعدة البيانات، مما يجعل نقطة النهاية هذه متاحة حتى بدون اتصال بقاعدة البيانات.

**الملف المصدر:** `template/app/api/categories/exists/route.ts`

## ملخص نقطة النهاية

|الطريقة|المسار|مصادقة|الوصف|
|--------|------|------|-------------|
|احصل على|`/api/categories/exists`|لا شيء|تحقق من وجود الفئات|
