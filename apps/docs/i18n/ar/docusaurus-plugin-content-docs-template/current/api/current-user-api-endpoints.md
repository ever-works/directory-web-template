...
title: نقاط النهاية لواجهة برمجة تطبيقات المستخدم الحالية
sidebar_label: واجهة برمجة تطبيقات المستخدم الحالي
sidebar_position: 60
---

# نقاط النهاية لواجهة برمجة تطبيقات المستخدم الحالية

توفر واجهة المستخدم الحالية API نقطة نهاية واحدة لاسترداد معلومات الملف الشخصي للمستخدم الذي تمت مصادقته. يتم استخدامه بواسطة الواجهة الأمامية لتحديد حالة المصادقة وامتيازات المستخدم.

**المصدر:** `template/app/api/current-user/route.ts`
