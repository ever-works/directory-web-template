...
title: استخراج نقاط النهاية API
sidebar_label: استخراج API
sidebar_position: 61
---

# استخراج نقاط النهاية API

توفر Extract API نقطة نهاية وكيل آمنة لاستخراج البيانات التعريفية للعنصر (الاسم والوصف والفئات وما إلى ذلك) من عنوان URL محدد. يقوم بإعادة توجيه الطلبات إلى Ever Works Platform API لاستخراج المحتوى المدعوم بالذكاء الاصطناعي.

**المصدر:** `template/app/api/extract/route.ts`
