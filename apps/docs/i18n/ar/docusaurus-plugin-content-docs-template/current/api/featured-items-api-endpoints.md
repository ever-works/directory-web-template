...
sidebar_label: واجهة برمجة تطبيقات العناصر المميزة
sidebar_position: 63
---

# العناصر المميزة نقاط نهاية واجهة برمجة التطبيقات

توفر واجهة برمجة التطبيقات للعناصر المميزة نقطة نهاية عامة لاسترداد العناصر المميزة المعروضة على موقع الويب. تتم إدارة العناصر المميزة من خلال لوحة الإدارة وتخزينها في قاعدة البيانات مع دعم الطلب والتنشيط وتواريخ انتهاء الصلاحية.

**المصدر:** `template/app/api/featured-items/route.ts`
