...
title: "العناصر المميزة نقاط نهاية واجهة برمجة التطبيقات"
sidebar_label: "العناصر المميزة"
sidebar_position: 18
---

# العناصر المميزة نقاط نهاية واجهة برمجة التطبيقات

توفر واجهة برمجة التطبيقات للعناصر المميزة نقطة نهاية عامة لاسترداد العناصر التي تم تمييزها لعرضها بشكل بارز على موقع الويب. تدعم العناصر المميزة الطلب وتواريخ انتهاء الصلاحية والحالات النشطة/غير النشطة.

**الملف المصدر:** `template/app/api/featured-items/route.ts`

## ملخص نقطة النهاية

|الطريقة|المسار|مصادقة|الوصف|
|--------|------|------|-------------|
|احصل على|`/api/featured-items`|لا شيء|احصل على العناصر المميزة النشطة للعرض العام|
...
|ملف|الغرض|
|------|---------|
|`template/app/api/featured-items/route.ts`|نقطة النهاية للعناصر المميزة العامة|
|`template/lib/db/schema.ts`|`featuredItems` تعريف الجدول|
