...
title: نقاط النهاية الداخلية لواجهة برمجة التطبيقات (API).
sidebar_label: واجهة برمجة التطبيقات الداخلية
sidebar_position: 64
---

# نقاط النهاية الداخلية لواجهة برمجة التطبيقات (API).

توفر واجهة برمجة التطبيقات الداخلية نقاط نهاية على مستوى النظام تُستخدم لعمليات البنية التحتية. تقتصر نقاط النهاية هذه على وضع التطوير ولا يمكن الوصول إليها في الإنتاج.

** دليل المصدر: ** `template/app/api/internal/`
