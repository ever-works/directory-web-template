...
title: Крайни точки на API за категории
sidebar_label: API за категории
sidebar_position: 56
---

# Крайни точки на API за категории

API за категории предоставя публична крайна точка за проверка дали съществуват категории в системата за съдържание. Категориите се извличат от базираното на Git хранилище на CMS съдържание и представляват таксономията от най-високо ниво за организиране на елементи.

**Източник:** `template/app/api/categories/exists/route.ts`
