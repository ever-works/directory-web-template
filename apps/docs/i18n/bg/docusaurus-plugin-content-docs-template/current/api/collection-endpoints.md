...
title: "Крайни точки на API за събиране"
sidebar_label: "Колекции"
sidebar_position: 11
---

# Крайни точки на API за събиране

API за колекции предоставя публична крайна точка за проверка дали съществуват активни колекции в системата. Колекциите се съхраняват в базата данни и се управляват чрез слоя хранилище за колекции.

**Изходен файл:** `template/app/api/collections/exists/route.ts`

## Крайна точка Резюме

|Метод|Пътека|авт|Описание|
|--------|------|------|-------------|
|ВЗЕМЕТЕ|`/api/collections/exists`|Няма|Проверете дали съществуват активни колекции|
