...
title: Крайни точки на API за колекции
sidebar_label: API за колекции
sidebar_position: 57
---

# Крайни точки на API за колекции

API за колекции предоставя публична крайна точка за проверка дали съществуват активни колекции в базата данни. Колекциите са подбрани групи от елементи, управлявани чрез административния панел и съхранявани в базата данни чрез хранилището за колекции.

**Източник:** `template/app/api/collections/exists/route.ts`
