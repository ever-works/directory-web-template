...
title: Текущи потребителски крайни точки на API
sidebar_label: Текущ потребителски API
sidebar_position: 60
---

# Текущи потребителски крайни точки на API

API за текущия потребител предоставя единична крайна точка за извличане на информация от профила на удостоверения потребител. Използва се от интерфейса за определяне на състоянието на удостоверяване и потребителските привилегии.

**Източник:** `template/app/api/current-user/route.ts`
