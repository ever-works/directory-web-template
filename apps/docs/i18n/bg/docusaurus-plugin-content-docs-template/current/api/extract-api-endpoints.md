...
title: Извличане на крайни точки на API
sidebar_label: Извличане на API
sidebar_position: 61
---

# Извличане на крайни точки на API

API за извличане предоставя защитена крайна точка на прокси за извличане на метаданни на елемент (име, описание, категории и т.н.) от даден URL адрес. Той препраща заявки към API на Ever Works Platform за извличане на съдържание, задвижвано от AI.

**Източник:** `template/app/api/extract/route.ts`
