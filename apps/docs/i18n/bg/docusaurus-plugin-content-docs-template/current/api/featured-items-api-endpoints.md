...
sidebar_label: API за избрани елементи
sidebar_position: 63
---

# Крайни точки на API за представени елементи

API за избрани елементи предоставя публична крайна точка за извличане на представени елементи, показани на уебсайта. Представените артикули се управляват чрез административния панел и се съхраняват в базата данни с поддръжка за поръчка, активиране и дати на изтичане.

**Източник:** `template/app/api/featured-items/route.ts`
