...
title: Вътрешни крайни точки на API
sidebar_label: Вътрешен API
sidebar_position: 64
---

# Вътрешни крайни точки на API

Вътрешният API предоставя крайни точки на системно ниво, използвани за инфраструктурни операции. Тези крайни точки са ограничени до режим на разработка и не са достъпни в производството.

**Директория източник:** `template/app/api/internal/`
