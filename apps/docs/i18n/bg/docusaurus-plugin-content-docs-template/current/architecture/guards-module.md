---
id: guards-module
title: Модул за охрана
sidebar_label: Модул за охрана
sidebar_position: 58
---

# Модул за охрана

Модулът за охрана (`template/lib/guards/`) осигурява базирана на план система за контрол на достъпа. Той определя кои абонаментни планове имат достъп до кои функции, налага цифрови ограничения за план и предоставя както функции за защита от страна на сървъра, така и подходящ за React създател на резултати за използване от страна на клиента.
...
|Файл|Описание|
|------|-------------|
|`lib/guards/index.ts`|Износ на варели|
|`lib/guards/plan-features.guard.ts`|Цялостно изпълнение на гарда|

## Йерархия на плана

Плановете са подредени по ниво, където по-високите нива включват всички характеристики на по-ниските нива, когато са конфигурирани с `minPlan`:
...
Всички налични функции са декларирани като константи:
...
Записът `FEATURE_ACCESS` преобразува всяка функция в нейното правило за достъп:
...
### Резюме на правилата за достъп

|Характеристика|Правило за достъп|
|---------|------------|
|`submit_product`|`'all'`|
...
Числени ограничения за функции с количествени ограничения. `null` показва неограничено.
...
## Функции за проверка на достъпа

### `canAccessFeature(feature: Feature, userPlan: string): boolean`

Проверка на основния достъп, която оценява правилото за достъп до функция:
...
Връща граничната стойност за план:
...
Проверява дали стойността е в лимита на плана:
...
Връща всички функции, достъпни от даден план.

### `getMinimumPlanForFeature(feature: Feature): PaymentPlan`

Връща най-ниския план, който има достъп до функция.

## План Guard Factory

### `createPlanGuard(userPlan: string)`

Създава инстанция на охрана с обвързани методи за конкретен план:
...
Персонализирана грешка, хвърлена от `requireFeature`:
...
Създава обикновен обект, подходящ за използване в кукички и компоненти на React:
