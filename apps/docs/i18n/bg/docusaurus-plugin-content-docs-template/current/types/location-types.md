...
Конфигурационните настройки, съхранени в `works.yaml` с помощта на `snake_case` именуване. Използва се при анализиране на секцията `settings.location` на конфигурационния файл.
