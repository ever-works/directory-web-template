...
Konfigurationseinstellungen wie in `works.yml` unter Verwendung von `snake_case` Benennung gespeichert. Wird beim Parsen des Abschnitts `settings.location` der Konfigurationsdatei verwendet.
