...
Estos puntos finales de administración gestionan los enlaces de navegación del sitio personalizados y el índice de ubicación geográfica. Los puntos finales de navegación permiten configurar enlaces personalizados de encabezado y pie de página almacenados en `works.yaml`. Los puntos finales del índice de ubicación gestionan el índice espacial utilizado para analíticas geográficas y funciones de mapa.
...
Recupera los elementos de navegación `custom_header` y `custom_footer` del archivo `works.yaml` del sitio. Devuelve arrays vacíos si no hay navegación personalizada configurada.
...
Actualiza los elementos de navegación personalizados del encabezado o pie de página en `works.yaml`. Valida el formato de la ruta de cada elemento para prevenir ataques XSS mediante esquemas de URL peligrosos.
