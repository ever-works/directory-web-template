...
La clase `ConfigManager` en `lib/config-manager.ts` gestiona el archivo `works.yaml` del repositorio CMS basado en Git. Maneja la lectura, escritura y confirmación de cambios de configuración.
