...
Las configuraciones de ubicación se definen en la sección `settings.location` del archivo `works.yml` del repositorio de contenido:
...
La estructura bruta leída de `works.yml`, definida en `lib/types/location.ts`:
