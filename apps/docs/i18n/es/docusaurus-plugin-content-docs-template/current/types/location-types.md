...
Los ajustes de configuración se almacenan en `works.yaml` usando el nombre `snake_case`. Se utiliza al analizar la sección `settings.location` del archivo de configuración.
