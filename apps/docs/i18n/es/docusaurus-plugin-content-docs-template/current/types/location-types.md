...
Los ajustes de configuración se almacenan en `works.yml` usando el nombre `snake_case`. Se utiliza al analizar la sección `settings.location` del archivo de configuración.
