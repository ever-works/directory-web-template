...
Paramètres de configuration tels que stockés dans `works.yml` en utilisant le nom `snake_case`. Utilisé lors de l'analyse de la section `settings.location` du fichier de configuration.
