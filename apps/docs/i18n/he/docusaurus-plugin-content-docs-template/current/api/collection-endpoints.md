...
ה-API של Collections מספק נקודת קצה ציבורית לבדיקה אם קיימים אוספים פעילים במערכת. אוספים מאוחסנים במסד הנתונים ומנוהלים באמצעות שכבת מאגר האוסף.

**קובץ מקור:** `template/app/api/collections/exists/route.ts`

## סיכום נקודות קצה

|שיטה|נתיב|Auth|תיאור|
|--------|------|------|-------------|
|קבל|`/api/collections/exists`|אין|בדוק אם קיימים אוספים פעילים|
