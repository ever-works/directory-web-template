...
title: נקודות קצה נוכחיות של User API
sidebar_label: משתמש API נוכחי
sidebar_position: 60
---

# נקודות קצה נוכחיות של User API

ממשק ה-API של המשתמש הנוכחי מספק נקודת קצה אחת כדי לאחזר את פרטי הפרופיל של המשתמש המאומת. הוא משמש את ה-frontend כדי לקבוע מצב אימות והרשאות משתמש.

**מקור:** `template/app/api/current-user/route.ts`
