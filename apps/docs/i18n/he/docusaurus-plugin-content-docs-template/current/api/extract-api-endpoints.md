...
title: חלץ נקודות קצה של ממשק API
sidebar_label: חילוץ API
sidebar_position: 61
---

# חלץ נקודות קצה של ממשק API

ה-Extract API מספק נקודת קצה מאובטחת של פרוקסי לחילוץ מטא נתונים של פריט (שם, תיאור, קטגוריות וכו') מכתובת אתר נתונה. הוא מעביר בקשות ל- Ever Works Platform API לחילוץ תוכן המופעל על ידי בינה מלאכותית.

**מקור:** `template/app/api/extract/route.ts`
