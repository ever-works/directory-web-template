...
sidebar_label: API של פריטים נבחרים
sidebar_position: 63
---

# נקודות קצה של פריטים נבחרים

ה-API של Featured Items מספק נקודת קצה ציבורית לאחזור פריטים מוצגים המוצגים באתר. פריטים נבחרים מנוהלים דרך פאנל הניהול ומאוחסנים במסד הנתונים עם תמיכה בהזמנה, הפעלה ותאריכי תפוגה.

**מקור:** `template/app/api/featured-items/route.ts`
