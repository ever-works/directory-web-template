...
title: "נקודות קצה של פריטים נבחרים"
sidebar_label: "פריטים נבחרים"
sidebar_position: 18
---

# נקודות קצה של פריטים נבחרים

ה-API של פריטים נבחרים מספק נקודת קצה ציבורית לאחזור פריטים שהודגשו לתצוגה בולטת באתר. פריטים מומלצים תומכים בהזמנה, תאריכי תפוגה ומצבים פעילים/לא פעילים.

**קובץ מקור:** `template/app/api/featured-items/route.ts`

## סיכום נקודות קצה

|שיטה|נתיב|Auth|תיאור|
|--------|------|------|-------------|
|קבל|`/api/featured-items`|אין|קבל פריטים מוצגים פעילים לתצוגה ציבורית|
...
|קובץ|מטרה|
|------|---------|
|`template/app/api/featured-items/route.ts`|נקודת קצה של פריטים מוצגים ציבוריים|
|`template/lib/db/schema.ts`|`featuredItems` הגדרת טבלה|
