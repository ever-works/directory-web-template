...
title: נקודות קצה פנימיות של ממשק API
sidebar_label: API פנימי
sidebar_position: 64
---

# נקודות קצה פנימיות של ממשק API

ה-API הפנימי מספק נקודות קצה ברמת המערכת המשמשות לפעולות תשתית. נקודות קצה אלו מוגבלות למצב פיתוח ואינן נגישות בייצור.

**ספריית מקור:** `template/app/api/internal/`
