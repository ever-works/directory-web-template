...
Impostazioni di configurazione memorizzate in `works.yaml` utilizzando la denominazione `snake_case`. Utilizzato durante l'analisi della sezione `settings.location` del file di configurazione.
