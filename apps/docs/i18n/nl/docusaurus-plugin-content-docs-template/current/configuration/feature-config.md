...
De klasse `ConfigManager` in `lib/config-manager.ts` beheert het bestand `works.yml` uit de Git-gebaseerde CMS-repository. Het verwerkt het lezen, schrijven en committen van configuratiewijzigingen.
