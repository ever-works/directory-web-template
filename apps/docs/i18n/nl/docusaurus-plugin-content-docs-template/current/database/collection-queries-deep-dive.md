...
Bedrijven in dit systeem vertegenwoordigen de organisaties achter beursgenoteerde items. Elk item kan tot maximaal één bedrijf behoren (afgedwongen door een unieke beperking op `itemSlug`).
