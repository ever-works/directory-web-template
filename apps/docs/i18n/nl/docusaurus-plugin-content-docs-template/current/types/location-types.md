...
Configuratie-instellingen zoals opgeslagen in `works.yaml` met `snake_case` naamgeving. Wordt gebruikt bij het parseren van de sectie `settings.location` van het configuratiebestand.
