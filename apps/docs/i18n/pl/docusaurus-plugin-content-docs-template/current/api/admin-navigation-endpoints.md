...
Zwraca bieżącą konfigurację nawigacji z `works.yaml`. Navigacja zawiera zarówno pozycje nagłówka, jak i stopki.
...
Aktualizuje elementy nawigacji nagłówka i/lub stopki. Zapisuje zmiany w `works.yaml`.
