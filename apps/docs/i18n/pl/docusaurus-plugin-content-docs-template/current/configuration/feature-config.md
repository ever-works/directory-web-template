...
Klasa `ConfigManager` w `lib/config-manager.ts` zarządza plikiem `works.yml` z repozytorium CMS opartego na Git. Obsługuje odczytywanie, zapisywanie i commitowanie zmian konfiguracji.
