...
Ustawienia konfiguracyjne zapisane w `works.yml` przy użyciu nazewnictwa `snake_case`. Używane podczas analizowania sekcji `settings.location` pliku konfiguracyjnego.
