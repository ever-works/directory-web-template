...
A classe `ConfigManager` em `lib/config-manager.ts` gerencia o arquivo `works.yml` do repositório CMS baseado em Git. Trata leitura, escrita e commit de alterações de configuração.
