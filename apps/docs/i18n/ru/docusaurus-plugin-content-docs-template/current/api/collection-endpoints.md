...
title: "Конечные точки API коллекции"
sidebar_label: "Коллекции"
sidebar_position: 11
---

# Конечные точки API коллекции

API коллекций предоставляет общедоступную конечную точку для проверки существования активных коллекций в системе. Коллекции хранятся в базе данных и управляются через уровень репозитория коллекций.

**Исходный файл:** `template/app/api/collections/exists/route.ts`

## Сводка конечных точек

|Метод|Путь|Авторизация|Описание|
|--------|------|------|-------------|
|ПОЛУЧИТЬ|`/api/collections/exists`|Нет|Проверьте, существуют ли активные коллекции|
