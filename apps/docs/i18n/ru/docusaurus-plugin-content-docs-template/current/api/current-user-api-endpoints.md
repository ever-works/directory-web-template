...
title: Текущие конечные точки пользовательского API
sidebar_label: API текущего пользователя
sidebar_position: 60
---

# Текущие конечные точки пользовательского API

API текущего пользователя предоставляет единую конечную точку для получения информации профиля аутентифицированного пользователя. Он используется внешним интерфейсом для определения состояния аутентификации и привилегий пользователя.
