...
sidebar_label: API избранных товаров
sidebar_position: 63
---

# Рекомендуемые элементы Конечные точки API

API избранных элементов предоставляет общедоступную конечную точку для получения избранных элементов, отображаемых на веб-сайте. Рекомендуемые элементы управляются через панель администратора и сохраняются в базе данных с поддержкой дат заказа, активации и срока действия.

**Источник:** `template/app/api/featured-items/route.ts`
