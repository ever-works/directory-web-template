...
test.describe('reference / tenant JSON discovery', () => {
	test('GET /api/reference responds non-5xx (HTML or JSON)', async ({ request }) => {
		...
		// `/api/reference` is the Scalar OpenAPI viewer (HTML), not a
		// JSON endpoint. Only verify shape if the route happens to
		// content-negotiate to JSON.
