...
export function ClientsTable(props: ClientsTableProps) {
	...
	return (
		<Card className="border-0 shadow-lg bg-white dark:bg-white/[0.03] overflow-hidden">
			<CardBody className="p-0">
				{/* Table Header with Filters */}
				<div className="px-6 py-4 border-b border-gray-100 dark:border-white/[0.06] bg-gray-50/50 dark:bg-white/[0.02]">
				...
				{/* Column Headers */}
				<div className="hidden md:flex items-center gap-4 px-6 py-3 bg-gray-50/80 dark:bg-white/[0.03] border-b border-gray-100 dark:border-white/[0.06]">
			...
			<div className="flex items-center gap-4">
				...
				<button
					...
					className={`flex items-center gap-3 flex-1 min-w-0 text-left rounded-lg p-1 -m-1 transition-colors ${
						isNavigating ? 'cursor-wait' : 'cursor-pointer hover:bg-gray-50 dark:hover:bg-white/[0.03]'
					}`}
