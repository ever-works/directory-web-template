					...
					<Card key={index} className="border-0 shadow-lg">
						<CardBody className="p-6">
							<div className="flex items-center justify-between">
								...
								<div className="h-8 w-16 bg-gray-200 dark:bg-white/[0.08] rounded-sm animate-pulse mb-2"></div>
								<div className="h-3 w-32 bg-gray-200 dark:bg-white/[0.08] rounded-sm animate-pulse"></div>
							</div>
							<div className="w-12 h-12 bg-gray-200 dark:bg-white/[0.08] rounded-xl animate-pulse"></div>
							</div>
						</CardBody>
