          ...
          <CardContent className="p-0">
            ...
            <div className="p-6 space-y-4">
              {Array.from({ length: 5 }, (_, i) => (
                <div key={i} className="flex items-center justify-between p-4 border border-gray-200 dark:border-white/[0.06] rounded-lg">
                ...
                <div
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : "bg-white dark:bg-white/[0.05] border-gray-200 dark:border-white/[0.06] hover:border-theme-primary/30 hover:shadow-lg"
                  )}
                >
                  {/* Loading overlay */}
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap gap-2 mb-3">
                              ...
                              {item.tags.slice(0, 3).map((tag, index) => (
                                <span
                                  key={index}
                                  className="inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium bg-gray-100 text-gray-800 dark:bg-white/[0.08] dark:text-gray-300"
                                >
                              ...
                              {item.tags.length > 3 && (
                                <span className="inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-medium bg-gray-100 text-gray-800 dark:bg-white/[0.08] dark:text-gray-300">
                                  <TagIcon className="w-3 h-3" />
