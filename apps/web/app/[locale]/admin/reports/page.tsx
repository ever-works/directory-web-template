...
const CLASSES = {
	...
	headerWrapper: 'mb-8',
	headerCard:
		'bg-gradient-to-r from-white via-gray-50 to-white dark:from-[#0a0a0a] dark:via-[#0a0a0a] dark:to-[#0a0a0a] rounded-2xl border border-gray-100 dark:border-white/[0.06] shadow-lg p-6',
	...
	searchInput:
		'w-full pl-12 pr-4 py-3 bg-white dark:bg-white/[0.05] border border-gray-200 dark:border-white/[0.06] rounded-xl focus:outline-none focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary transition-all duration-200 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400',
	...
	reportCard:
		'group bg-white dark:bg-white/[0.05] rounded-xl border border-gray-200 dark:border-white/[0.06] hover:border-theme-primary/30 hover:shadow-lg transition-all duration-300 p-5',
	...
	reportFooter: 'flex items-center justify-between pt-3 border-t border-gray-100 dark:border-white/[0.06]',
	...
	paginationInfo:
		'bg-gradient-to-r from-gray-50 to-white dark:from-[#0a0a0a] dark:to-[#0a0a0a] rounded-xl border border-gray-100 dark:border-white/[0.06] px-6 py-4 shadow-sm',
	...
	// Loading skeleton
	loadingSkeleton: 'bg-gray-200 dark:bg-white/[0.08] rounded animate-pulse'
} as const;
...
const STATUS_STYLES: Record<ReportStatusValues, { bg: string; text: string; icon: typeof Clock }> = {
	...
	dismissed: { bg: 'bg-gray-100 dark:bg-white/[0.08]', text: 'text-gray-700 dark:text-gray-300', icon: X }
};
...
const REASON_STYLES: Record<ReportReasonValues, { bg: string; text: string }> = {
	...
	other: { bg: 'bg-gray-100 dark:bg-white/[0.08]', text: 'text-gray-700 dark:text-gray-300' }
};
			...
			<div className={CLASSES.pageContainer}>
				...
				<div className={CLASSES.statsGrid}>
					{Array.from({ length: 4 }, (_, i) => (
						<div key={i} className={`${CLASSES.statCard} bg-gray-50 dark:bg-white/[0.05]`}>
				...
				<div className={CLASSES.reportsContainer}>
					{Array.from({ length: 3 }, (_, i) => (
						...
						<div className="flex justify-between pt-3 border-t border-gray-100 dark:border-white/[0.06]">
