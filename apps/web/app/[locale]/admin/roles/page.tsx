...
const headerContainerClass = clsx(
	...
	'rounded-2xl border border-gray-100 dark:border-white/6 shadow-lg p-6'
);
...
const searchInputClass = clsx(
	'w-full pl-12 pr-4 py-3 bg-white dark:bg-white/5',
...
const filterSelectClass = clsx(
	'appearance-none bg-white dark:bg-white/5',
	'border border-gray-200 dark:border-white/6 rounded-full',
									...
									<div className="flex items-center justify-between">
										<div className="flex items-center space-x-4 flex-1">
											<div className="flex items-center space-x-3">
												<div className="w-10 h-10 bg-gray-200 dark:bg-white/8 rounded-full animate-pulse"></div>
												<div className="flex-1">
				...
				<div className={headerContainerClass}>
					<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
						<div className="flex items-center space-x-4">
							...
							<div>
								<h1 className={headerTitleClass}>{t('TITLE')}</h1>
			...
			<div className="mb-6">
				...
				<div className="mt-4 flex items-center justify-between text-sm text-gray-600 dark:text-gray-400">
					<span>
						...
						{(searchTerm || statusFilter !== 'all' || roleTypeFilter !== 'all') && (
							<span className="ml-1">{t('FILTERED')}</span>
						)}
					</span>
				</div>
			</div>
					...
					{filteredRoles.length === 0 ? (
						...
						<div className="divide-y divide-gray-100 dark:divide-white/6">
							{filteredRoles.map((role) => (
								<div
									key={role.id}
									className="px-6 py-4 hover:bg-gray-50 dark:hover:bg-white/3 transition-colors"
								>
									<div className="flex items-center justify-between">
										<div className="flex items-center space-x-4 flex-1">
											<div className="flex items-center space-x-3">
												<div
													className={clsx(
														'w-10 h-10 bg-linear-to-br rounded-full flex items-center justify-center text-white font-semibold text-sm',
														getAvatarColor(role.name || role.id)
													)}
												>
