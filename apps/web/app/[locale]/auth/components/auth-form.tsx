...
export function AuthForm({ form, showSocialLogin = true, onSuccess, clientMode = false }: { form: "login" | "signup", showSocialLogin?: boolean, onSuccess?: () => void, clientMode?: boolean }) {
  ...
  return (
    <div className="flex items-center justify-center py-8 px-4 relative bg-gray-50 dark:bg-white/[0.03]">
      {/* Animated background */}
      <AnimatedBackground />
      <GeometricDecoration />
      {/* Main container with modern design */}
      <AnimatedContainer type="scaleIn" duration="slow" easing="bounce">
        <div className="w-full max-w-5xl mx-auto rounded-2xl bg-white/80 dark:bg-white/[0.03] backdrop-blur-xl border border-white/20 dark:border-white/[0.06] shadow-2xl overflow-hidden">
          <div className="flex flex-col lg:flex-row min-h-[400px] lg:min-h-[500px]">
            ...
            {/* Form side */}
            <div className="w-full lg:w-1/2 p-4 lg:p-6 flex flex-col justify-center bg-white/50 dark:bg-white/[0.03] backdrop-blur-xs">
