...
import { SecurityIcon, GeometricDecoration, TrustBadge } from '@/components/ui/auth-illustrations';
          ...
          <div className="flex flex-col lg:flex-row min-h-[300px] lg:min-h-[400px]">
            ...
            <div className="w-full lg:w-1/2 relative p-6 lg:p-8 flex flex-col justify-center">
              ...
              <div className="space-y-6">
                ...
                {/* Security features with staggered animations */}
                <StaggerContainer staggerDelay={150} className="space-y-4">
                  <div className="flex items-center">
                    <div className="bg-gray-100 dark:bg-white/5 p-3 rounded-xl mr-4 group hover:bg-gray-200 dark:hover:bg-white/10 transition-colors">
                      <Mail className="h-3 w-3 text-gray-400 dark:text-gray-500 group-hover:text-theme-primary transition-colors" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center">
                    <div className="bg-gray-100 dark:bg-white/5 p-3 rounded-xl mr-4 group hover:bg-gray-200 dark:hover:bg-white/10 transition-colors">
                      <AlertCircle className="h-3 w-3 text-gray-400 dark:text-gray-500 group-hover:text-theme-primary transition-colors" />
                    </div>
                    <div>
                      <span className="font-semibold text-sm text-gray-900 dark:text-white block">
                        {t('SECURE_RESET_LINK')}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="text-center">
                      <div className="space-y-2">
                        <h1 className="text-2xl font-bold text-white">{t('RESET_PASSWORD')}</h1>
                    ...
                    {state.success ? (
                      <div className="space-y-6">
                        ...
                        {/* Help section */}
                        <div className="p-4 bg-gray-800/50 rounded-xl border border-gray-700/50 backdrop-blur-xs">
                          ...
                          <ul className="space-y-2 text-sm text-gray-300">
                            ...
                            <li className="flex items-center space-x-2">
                              <div className="w-1.5 h-1.5 bg-theme-primary rounded-full"></div>
                              <span>{tForgot('INVALID_EMAIL')}</span>
                            </li>
                            <li className="flex items-center space-x-2">
                              <div className="w-1.5 h-1.5 bg-theme-primary rounded-full"></div>
