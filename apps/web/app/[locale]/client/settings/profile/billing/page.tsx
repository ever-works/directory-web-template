...
export default function BillingPage() {
	...
	return (
		<Container maxWidth="7xl" padding="default">
				...
				<div className="space-y-8 flex justify-between">
					...
					<div className="flex items-center gap-3">
						...
						<button
							...
							className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white dark:bg-white/[0.05] border border-gray-300 dark:border-white/[0.06] rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-colors disabled:opacity-50 dark:text-slate-100"
						>
			...
			{/* Loading State */}
			{loading && (
				<div className="text-center py-16 dark:bg-white/[0.05] dark:text-slate-100">
				...
				<div className="mt-10">
					...
					{activeTab === 'overview' && (
						<div className="space-y-8">
							...
							<div className="bg-white dark:bg-white/[0.05] border border-gray-200 dark:border-white/[0.06] rounded-lg p-3 shadow-sm">
							...
							{/* Recent Activity */}
							<div className="bg-white dark:bg-white/[0.05] border border-gray-200 dark:border-white/[0.06] rounded-xl p-6 shadow-sm">
								...
								{!hasPaymentHistory ? (
									...
									<div className="space-y-4">
										{payments.slice(0, 3).map((payment) => (
											<div
												key={payment.id}
												className="flex items-center justify-between p-4 bg-gray-50 dark:bg-white/[0.05] rounded-lg hover:bg-gray-100 transition-colors shadow-sm border border-gray-200 dark:border-white/[0.06]"
											>
					...
					{activeTab === 'payments' && (
						<div className="space-y-6">
							...
							{filteredPayments.length === 0 ? (
								...
								<div className="bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/[0.06] rounded-xl p-6 shadow-sm">
									<div className="space-y-4">
