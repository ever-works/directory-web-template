							...
							<form className="space-y-6" onSubmit={handleSubmit} noValidate>
								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
									<div className="space-y-2">
										...
										<input
											...
											className="w-full h-14 px-6 text-lg bg-white dark:bg-white/5 border-2 border-gray-300 dark:border-white/8 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-theme-primary-500 focus:border-theme-primary-500 hover:border-gray-400 dark:hover:border-white/8 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500"
											value={title}
								...
								<div className="space-y-2">
									...
									<textarea
										...
										className="w-full px-6 py-4 text-lg bg-white dark:bg-white/5 border-2 border-gray-300 dark:border-white/8 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-theme-primary-500 focus:border-theme-primary-500 hover:border-gray-400 dark:hover:border-white/8 resize-none text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500"
										value={description}
								...
								<div className="flex items-center gap-4">
									<label className="flex items-center gap-2 cursor-pointer">
										<input
											type="checkbox"
											name="isFeatured"
											className="w-4 h-4 rounded border-gray-300 dark:border-white/8 text-theme-primary-600 bg-white dark:bg-white/5 focus:ring-2 focus:ring-theme-primary-500 focus:ring-offset-0"
											checked={isFeatured}
...
function PortfolioItem({ project, onEdit, onDelete }: PortfolioItemProps) {
	return (
		<div className="flex items-start gap-4 p-4 border border-gray-200 dark:border-white/6 rounded-lg hover:bg-gray-50 dark:hover:bg-white/6 transition-colors">
				...
				<div className="flex items-start justify-between">
					<div className="flex-1">
						...
						<div className="flex flex-wrap gap-1">
							{project.tags.map((tag) => (
								<span
									key={tag}
									className="inline-flex items-center px-2 py-1 bg-gray-100 dark:bg-white/5 text-gray-700 dark:text-gray-300 rounded text-xs"
								>
									{tag}
								</span>
							))}
					...
					<div className="flex items-center gap-2 ml-4">
						<a
							...
							className="p-2 text-gray-400 dark:text-gray-500 hover:text-theme-primary-600 dark:hover:text-theme-primary-400 transition-colors rounded-lg hover:bg-gray-100 dark:hover:bg-white/6"
							title="View project"
						>
						...
						<button
							className="p-2 text-gray-400 dark:text-gray-500 hover:text-red-600 dark:hover:text-red-400 transition-colors rounded-lg hover:bg-gray-100 dark:hover:bg-white/6"
