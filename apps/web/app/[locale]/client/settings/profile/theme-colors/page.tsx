...
const getThemeButtonClasses = (isSelected: boolean) =>
	cn(
		...
		isSelected
			...
			: 'border-gray-200 dark:border-white/6 bg-white dark:bg-white/3 hover:border-theme-primary-300 dark:hover:border-theme-primary-600 hover:bg-gray-50 dark:hover:bg-white/5'
	);
		...
		<div className="min-h-screen bg-linear-to-br from-gray-50 via-white to-gray-50 dark:from-[#0a0a0a] dark:via-[#0a0a0a] dark:to-[#0a0a0a]">
			<Container maxWidth="7xl" padding="default">
				<div className="space-y-12 py-8">
					...
					{/* Theme Selector */}
					<Card className="hover:shadow-lg hover:shadow-theme-primary-500/10 border border-gray-200 dark:border-white/6 transition-all duration-300 bg-white/95 dark:bg-[#141414]/95 backdrop-blur-sm">
										...
										>
											...
											<div className="flex items-center gap-3 mb-4">
												<div className="flex gap-1">
													<span
														className="inline-block w-8 h-6 rounded-md shadow-sm border border-gray-200 dark:border-white/8"
												...
												<div className="flex-1">
													<h3
														className={`font-semibold text-lg ${isSelected ? 'text-theme-primary-700 dark:text-theme-primary-400' : 'text-gray-900 dark:text-gray-100'} group-hover:text-theme-primary-700 dark:group-hover:text-theme-primary-400 transition-colors`}
													>
														{theme.label}
													</h3>
												</div>
											...
											{/* Description */}
											<p
												className={`text-sm leading-relaxed ${isSelected ? 'text-theme-primary-600 dark:text-theme-primary-300' : 'text-gray-600 dark:text-gray-300'}`}
											>
												{theme.description}
											</p>
										</button>
