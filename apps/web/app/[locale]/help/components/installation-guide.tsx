						...
						<div className="space-y-4">
							{installationSteps.map((step, index) => (
								...
								>
									{/* Step Card */}
									<div
										className={`relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-xs rounded-xl p-6 border-2 transition-all duration-300 ${
											activeStep === index
				...
				<div className="mt-16 text-center">
					<div className="bg-linear-to-r from-green-50 to-blue-50 dark:from-green-900/30 dark:to-blue-900/30 rounded-2xl p-8 border border-green-200 dark:border-green-800">
						...
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							...
							<Button
								variant="outline"
								className="border-2 border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 font-semibold px-8 py-3 rounded-xl transition-all duration-300"
							>
								View Documentation
							</Button>
						</div>
