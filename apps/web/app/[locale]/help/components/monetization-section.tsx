      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="bg-white/80 dark:bg-white/[0.03] backdrop-blur-xs rounded-xl p-6 border border-slate-200 dark:border-white/[0.06] hover:bg-white dark:hover:bg-white/[0.06] transition-all duration-300 hover:transform hover:scale-105"
            >
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {monetizationMethods.map((method, index) => (
            ...
            >
              {/* Method Card */}
              <div className={`relative bg-white/80 dark:bg-white/[0.03] backdrop-blur-xs rounded-2xl p-8 border-2 transition-all duration-300 h-full ${
                activeMethod === index
        ...
        <div className="mb-16">
          <div className="bg-white/90 dark:bg-white/[0.03] backdrop-blur-xs rounded-2xl border border-slate-200 dark:border-white/[0.06] shadow-2xl overflow-hidden">
            ...
            <div className="bg-slate-100 dark:bg-[#0a0a0a] px-6 py-4 border-b border-slate-200 dark:border-white/[0.06]">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="border-slate-300 dark:border-white/[0.08] text-slate-700 dark:text-slate-300"
                >
            ...
            <div className="p-6">
              ...
              {/* Expanded Details */}
              {showDetails && (
                <div className="mt-8 pt-8 border-t border-slate-200 dark:border-white/[0.06]">
