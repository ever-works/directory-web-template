    ...
    <section className="py-20 bg-linear-to-br from-slate-50 via-white to-slate-100 dark:from-[#0a0a0a] dark:via-[#0a0a0a] dark:to-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/80 dark:bg-white/[0.03] backdrop-blur-xs rounded-xl p-6 border border-slate-200 dark:border-white/[0.06] hover:bg-white dark:hover:bg-white/[0.06] transition-all duration-300 hover:transform hover:scale-105">
        ...
        {/* Controls */}
        <div className="bg-white/90 dark:bg-white/[0.03] backdrop-blur-xs rounded-2xl border border-slate-200 dark:border-white/[0.06] shadow-xl p-6 mb-8">
          <div className="flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <select
                ...
                className="px-3 py-2 bg-slate-100 dark:bg-white/[0.08] border border-slate-200 dark:border-white/[0.08] rounded-lg text-sm text-slate-700 dark:text-slate-300 focus:outline-hidden focus:ring-2 focus:ring-indigo-500"
              >
              ...
              <div className="flex bg-slate-100 dark:bg-white/[0.08] rounded-lg p-1">
                <button
        ...
        <div className="mt-12 text-center">
          <div className="bg-white/80 dark:bg-white/[0.03] backdrop-blur-xs rounded-2xl p-6 border border-slate-200 dark:border-white/[0.06]">
