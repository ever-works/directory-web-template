 ...
 *     description: Retrieves custom_header and custom_footer navigation items from works.yaml. Admin access required.
 *     tags:
 *       - Admin - Navigation
 *     security:
 *       - bearerAuth: []
 ...
 *     description: Updates custom_header or custom_footer navigation items in works.yaml. Validates path format to prevent XSS attacks. Only paths starting with /, http://, or https:// are allowed. Admin access required.
 *     tags:
 *       - Admin - Navigation
 *     security:
 *       - bearerAuth: []
