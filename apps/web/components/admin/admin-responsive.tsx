...
export function AdminResponsiveCard({ 
  ...
  return (
    <div className={cn(
      "bg-white dark:bg-white/[0.03] rounded-xl shadow-xs border border-gray-200 dark:border-white/[0.06]",
      getVariantStyles(),
      className
    )}>
      {children}
...
export function AdminResponsiveNav({ 
  ...
  return (
    <nav className={cn("relative", className)}>
      {/* Mobile header */}
      <div className="md:hidden flex items-center justify-between p-4 border-b border-gray-200 dark:border-white/[0.06]">
...
export function AdminResponsiveChart({ 
  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      <div className={cn(
        "w-full bg-gray-50 dark:bg-white/[0.05] rounded-lg p-3 md:p-4",
        getHeightStyles()
      )}>
        {children}
      </div>
