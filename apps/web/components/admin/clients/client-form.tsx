...
export function ClientForm({ client, onSubmit, onCancel, isLoading = false, mode }: ClientFormProps) {
  ...
  const containerClasses = "bg-white dark:bg-white/[0.03] rounded-2xl shadow-2xl border border-gray-200 dark:border-white/[0.06] overflow-hidden";
  const headerClasses = "bg-linear-to-r from-theme-primary to-theme-accent px-6 py-4";
  const formClasses = "p-6 space-y-6";
  const actionsClasses = "flex items-center justify-between pt-6 border-t border-gray-200 dark:border-white/[0.06]";
  ...
  return (
    <div className={containerClasses}>
      ...
      {/* Step Indicator */}
      <div className="px-6 py-4 bg-gray-50 dark:bg-white/[0.05] border-b border-gray-200 dark:border-white/[0.06]">
                ...
                <div
                  className={clsx(
                    ...
                    currentStep === step
                      ...
                      : "bg-gray-300 dark:bg-white/[0.1] text-gray-600 dark:text-gray-400"
                  )}
                >
                  {step}
                </div>
