...
export function CompanyModal({ isOpen, mode, company, isSubmitting, onSubmit, onClose }: CompanyModalProps) {
	...
	return (
		<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
			<div className="w-full max-w-2xl bg-white dark:bg-white/[0.03] rounded-xl shadow-xl max-h-[calc(100vh-4rem)] overflow-y-auto">
				{/* Header */}
				...
				<form onSubmit={handleSubmit(handleFormSubmit)} className="p-6 space-y-6">
					...
					<div>
						...
						>
							<Select.Trigger
								className={cn(
									"flex h-12 w-full items-center justify-between rounded-lg border border-gray-300 dark:border-white/[0.08] bg-white dark:bg-white/[0.05] px-3 py-2 text-sm",
