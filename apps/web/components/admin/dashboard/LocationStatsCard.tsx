...
const CARD_STYLES = 'bg-white dark:bg-[#0a0a0a] rounded-xl shadow-xs border border-gray-200 dark:border-white/[0.06] p-4 md:p-6';
...
const PROGRESS_TRACK_STYLES = 'w-full h-2 bg-gray-200 dark:bg-white/[0.08] rounded-full overflow-hidden';
