              ...
              <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-4 space-y-2">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm font-mono bg-white dark:bg-white/8 text-gray-900 dark:text-gray-100 px-2 py-1 rounded-sm border border-gray-200 dark:border-white/8">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-50 dark:bg-white/5 rounded-lg p-4 space-y-3">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 border border-gray-200 dark:border-white/8 rounded-lg bg-white dark:bg-white/8 flex items-center justify-center">
                    {mediaLinks.icon_url ? (
                      <img
