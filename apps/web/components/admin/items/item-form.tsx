...
export function ItemForm({ item, mode, onSubmit, onCancel, isLoading = false }: ItemFormProps) {
  ...
  return (
    <div className="bg-white dark:bg-white/3 rounded-2xl shadow-2xl border border-gray-200 dark:border-white/6 overflow-hidden">
      {/* Header */}
...
{t('GENERATE')}
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray-300 dark:border-white/8 rounded-md text-sm transition-colors focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-white/8 text-gray-900 dark:text-white"
          />
          <p className='text-xs text-gray-500 dark:text-gray-400'>
            {t('TAGS_HELP')}
          </p>
