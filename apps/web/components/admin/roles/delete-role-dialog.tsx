  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden="true"
      />
      <div className="relative bg-white dark:bg-white/[0.03] rounded-lg shadow-xl max-w-md w-full mx-4">
        {/* Header */}
        ...
        {/* Footer */}
        <div className="flex justify-end space-x-3 p-6 border-t border-gray-200 dark:border-white/[0.06] bg-gray-50 dark:bg-white/[0.05]">
          <Button
            variant="bordered"
