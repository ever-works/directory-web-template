...
const SEARCH_INPUT_CLASSES =
	'w-full pl-12 pr-10 py-3 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/6 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary transition-all duration-200 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400';
