...
export function TagForm({ tag, mode, onSubmit, onCancel, isLoading = false }: TagFormProps) {
  ...
  const normalInputClasses = "border-gray-300 dark:border-white/8 bg-white dark:bg-white/8 text-gray-900 dark:text-white";
  const disabledInputClasses = "bg-gray-100 dark:bg-white/1 cursor-not-allowed";
  ...
  return (
    <div className="bg-white dark:bg-white/5 rounded-lg shadow-xl border border-gray-200 dark:border-white/6">
      {/* Header */}
