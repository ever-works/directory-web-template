...
export default function UserForm({ user, onSuccess, isSubmitting = false, onCancel }: UserFormProps) {
  ...
  return (
    <>
      ...
      <div className="px-6 py-4 border-b border-gray-200 dark:border-white/[0.06] bg-linear-to-r from-gray-50 to-white dark:from-[#0a0a0a] dark:to-[#0a0a0a]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          >
            <Select.Trigger
              className={cn(
                "flex h-10 w-full items-center justify-between rounded-lg border border-gray-300 dark:border-white/[0.08] bg-white dark:bg-white/[0.05] px-3 py-2 text-sm",
      ...
      {/* Action Buttons */}
      <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-white/[0.06] bg-linear-to-r from-gray-50 to-white dark:from-[#0a0a0a] dark:to-[#0a0a0a] -mx-6 -mb-6 px-6 pb-6">
        {onCancel && (
          <Button
            variant="bordered"
            onPress={onCancel}
