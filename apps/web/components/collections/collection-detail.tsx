...
const STICKY_CONTAINER_ACTIVE = `${STICKY_CONTAINER_BASE} bg-white/95 dark:bg-white/[0.05] shadow-md backdrop-blur-xs border border-gray-100 dark:border-white/[0.06] px-4 py-3`;
