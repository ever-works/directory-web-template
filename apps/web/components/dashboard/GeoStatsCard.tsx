...
const SKELETON_BODY_STYLES = 'h-64 bg-gray-200 dark:bg-white/[0.08] rounded-sm';
const PROGRESS_BG_STYLES = 'w-full h-2 bg-gray-200 dark:bg-white/[0.08] rounded-full overflow-hidden';
