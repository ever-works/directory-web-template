								...
								<div className="p-4 space-y-3">
									...
									<div className="flex items-center gap-3">
										...
										<div className="flex-1">
											<input
												...
												className="w-full h-9 px-3 text-sm font-medium bg-white dark:bg-white/[0.05] border border-gray-200 dark:border-white/[0.08] rounded-lg outline-none text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:border-theme-primary-500 dark:focus:border-theme-primary-400 focus:ring-1 focus:ring-theme-primary-500/30 transition-all duration-200"
											/>
										</div>
									...
									<div className="relative">
										<input
											...
											required={isMain}
											className={cn(
												'w-full h-10 px-4 pr-12 text-sm bg-white dark:bg-white/[0.05] border border-gray-200 dark:border-white/[0.08] rounded-xl transition-all duration-200 outline-none text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500',
											...
											{isMain && onExtract && link.url && link.url.match(/^https?:\/\//) && (
												<button
													...
													className={cn(
														...
														isExtracting
															? 'bg-gray-100 text-gray-400 cursor-wait dark:bg-white/[0.05] dark:text-gray-500'
