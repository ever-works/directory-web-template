	...
	return (
		<div className="space-y-4">
					...
					return (
						<div
							...
							className={cn(
								...
								isMain
									? 'border-theme-primary-200 dark:border-theme-primary-800/60 bg-theme-primary-50/30 dark:bg-theme-primary-900/10'
						...
						>
							...
							<div className="flex items-center gap-2 px-3 pt-3 pb-2">
								<div className="shrink-0 w-7 h-7 rounded-md bg-theme-primary-500/10 dark:bg-theme-primary-500/20 flex items-center justify-center">
									{isMain
										? <Globe className="w-3.5 h-3.5 text-theme-primary-500 dark:text-theme-primary-400" />
										: <Link2 className="w-3.5 h-3.5 text-theme-primary-500 dark:text-theme-primary-400" />
									}
								</div>
								<input
									type="text"
								...
								/>
								{isMain && (
									<span className="shrink-0 px-1.5 py-0.5 text-[10px] font-semibold tracking-wide bg-theme-primary-500 text-white rounded-md">
								...
								<input
									...
									className={cn(
										...
										focusedField === `link-${link.id}`
											? 'border-theme-primary-400 dark:border-theme-primary-500 ring-1 ring-theme-primary-500/30'
			...
			<button
				type="button"
				onClick={addLink}
				className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg border border-dashed border-gray-300 dark:border-white/10 text-gray-500 dark:text-gray-400 hover:border-theme-primary-400 dark:hover:border-theme-primary-600 hover:text-theme-primary-600 dark:hover:text-theme-primary-400 transition-all duration-150"
			>
