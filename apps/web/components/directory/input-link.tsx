							...
							<div
								...
								className={cn(
									...
									isMain
										...
										: 'border-gray-200 dark:border-white/[0.08] bg-white/50 dark:bg-white/[0.03]',
								...
								<div className="p-4 space-y-3">
									...
									<div className="flex items-center gap-3">
										...
										<div className="flex-1">
											<input
												...
												className="w-full h-10 px-3 text-sm font-medium bg-transparent border border-gray-200 dark:border-white/[0.08] rounded-lg outline-hidden text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-theme-primary-500 dark:focus:border-theme-primary-400 focus:ring-2 focus:ring-theme-primary-20 transition-all duration-200"
											/>
										</div>
									...
									<div className="relative">
										<input
											...
											required={isMain}
											className={cn(
												'w-full h-12 px-4 pr-12 text-base bg-white dark:bg-white/[0.05] border-2 border-gray-200 dark:border-white/[0.08] rounded-xl transition-all duration-300 outline-hidden text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400',
