        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          >
            ...
            <div className="relative bg-white/95 dark:bg-white/[0.05] backdrop-blur-xl rounded-3xl border border-white/20 dark:border-white/[0.04] p-8 shadow-2xl">
              ...
              <div className="flex justify-between items-center p-6 bg-linear-to-r from-gray-50/80 to-theme-primary-50/80 dark:from-[#0a0a0a]/40 dark:to-theme-primary-900/40 rounded-2xl border border-gray-200/30 dark:border-white/[0.04]">
              ...
              <div className="grid gap-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <div className="p-4 bg-gray-50/80 dark:bg-white/[0.03] rounded-xl border border-gray-200/50 dark:border-white/[0.06]">
            ...
            <div className="relative bg-white/95 dark:bg-white/[0.05] backdrop-blur-xl rounded-3xl border border-white/20 dark:border-white/[0.04] p-8 shadow-2xl">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-gray-50/80 dark:bg-white/[0.03] rounded-xl border border-gray-200/50 dark:border-white/[0.06]">
                    <div
                      className={cn(
