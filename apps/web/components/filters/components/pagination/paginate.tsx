              ...
              <Pagination
                ...
                classNames={{
                  ...
                  prev: cn(
                    ...
                    "bg-linear-to-r from-gray-50 to-gray-100 dark:from-[#0a0a0a] dark:to-white/8",
                    "text-gray-600 dark:text-gray-300 hover:text-theme-primary dark:hover:text-theme-primary",
                    "border border-gray-200 dark:border-white/8 hover:border-theme-primary dark:hover:border-theme-primary",
