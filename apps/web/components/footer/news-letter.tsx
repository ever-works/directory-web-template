			...
			<form action={formAction} className="space-y-3">
				<div className="flex flex-col sm:flex-row gap-2">
					<input
						...
						aria-label={t('footer.ENTER_EMAIL')}
						disabled={pending}
					...
					<button
						type="submit"
						disabled={pending}
						className="mt-2 sm:mt-0 w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-1.5 rounded-lg bg-gray-900 text-gray-100 dark:bg-white dark:text-black font-medium hover:bg-gray-100 dark:hover:bg-gray-200
