	...
	return (
		<section className={`w-full ${className ?? ''}`}>
			<div className="flex items-center gap-3 mb-6">
				...
				<h3 className="text-xl font-semibold bg-[linear-gradient(90deg,rgb(99,102,241),rgba(168,85,247,0.8))] bg-clip-text text-transparent">
					{title}
				</h3>
				<span className="text-xs px-3 py-1 rounded-full bg-white/5 dark:bg-white/3 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-white/6">
