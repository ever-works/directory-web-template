		...
		<div className="space-y-4" id={id} aria-describedby={ariaDescribedBy}>
			...
			<button
				...
				className={cn(
					...
					'bg-gray-100 dark:bg-white/[0.08] hover:bg-gray-200 dark:hover:bg-white/[0.06]',
			...
			{/* Map preview */}
			{showMap && (
				<div className="relative rounded-lg overflow-hidden border border-gray-200 dark:border-white/[0.06]">
					{isMapLoading && (
						<div
							className="absolute inset-0 bg-gray-100 dark:bg-white/[0.05] flex items-center justify-center z-10"
					...
					{errors?.coordinates && (
						<p className="absolute bottom-2 left-2 text-xs text-red-500 bg-white dark:bg-white/[0.05] px-2 py-1 rounded">
							{errors.coordinates}
						</p>
					)}
				</div>
			...
			{showServiceArea && (
				<div className="relative">
					...
					{isServiceAreaOpen && (
						<div className="absolute z-20 w-full mt-1 bg-white dark:bg-white/[0.05] border border-gray-200 dark:border-white/[0.06] rounded-lg shadow-lg">
			...
			{showRemoteOption && (
				<label className="flex items-center gap-3 cursor-pointer">
					<input
						...
						disabled={isDisabled}
						className={cn(
							'w-5 h-5 rounded border-gray-300 dark:border-white/[0.08]',
