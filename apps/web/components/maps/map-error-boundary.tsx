...
export class MapErrorBoundary extends Component<MapErrorBoundaryProps, MapErrorBoundaryState> {
	...
	render(): ReactNode {
		if (this.state.hasError) {
			...
			return (
				<div className="flex flex-col items-center justify-center p-6 text-center bg-gray-50 dark:bg-white/[0.05] rounded-xl border border-gray-200 dark:border-white/[0.06]">
