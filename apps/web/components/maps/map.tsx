...
const mapDisabledStyles =
	'bg-gray-100 dark:bg-white/5 flex flex-col items-center justify-center';
...
export function Map({
	...
	return (
		<div
			className={cn(mapContainerBaseStyles, 'border border-gray-200 dark:border-white/6', className)}
			style={{ height: heightStyle, width: widthStyle }}
		>
			{/* Loading overlay */}
			{showLoading && (
			...
			{controls.showFullscreenControl && !showLoading && (
				<button
					...
					className="absolute top-3 right-3 z-10 p-2 bg-white dark:bg-white/5 rounded-lg shadow-md hover:bg-gray-50 dark:hover:bg-white/6 transition-colors"
