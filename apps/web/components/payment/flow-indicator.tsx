...
export function PaymentFlowIndicator({
  ...
  const flowTheme = useMemo((): FlowTheme => {
    ...
    return {
      ...
      borderColor: "border-slate-200 dark:border-white/6",
  ...
  if (!isHydrated) {
    return (
      <div className={cn(
        "flex items-center justify-center p-4 rounded-lg border border-slate-200 dark:border-white/6",
  ...
  return (
      ...
      <div className="relative z-10 p-4">
        ...
        {showFeatures && flowConfig.features && (
          <div className="mt-3 pt-3 border-t border-slate-200 dark:border-white/6">
      ...
      {animated && isHovered && interactive && !disabled && (
        <div className="absolute inset-0 bg-slate-100 dark:bg-white/8 opacity-10 pointer-events-none" />
      )}
