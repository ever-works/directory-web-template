      ...
      <div className="relative z-10 px-6 py-12">
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="relative w-full bg-gray-200 dark:bg-white/8 rounded-full h-3 overflow-hidden shadow-inner">
              <div
        ...
        <div className="grid xl:grid-cols-3 gap-12">
            ...
            >
              ...
              <div className="relative bg-white/95 dark:bg-white/5 backdrop-blur-xl rounded-3xl border border-white/20 dark:border-white/4 p-8 shadow-2xl">
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center p-6 bg-linear-to-r from-gray-50/80 to-blue-50/80 dark:from-[#0a0a0a]/40 dark:to-blue-900/40 rounded-2xl border border-gray-200/30 dark:border-white/4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <input
                          ...
                          required
                          className={cn(
                            "w-full h-14 px-6 pr-14 text-lg bg-gray-50/80 dark:bg-white/3 border-2 border-gray-200/60 dark:border-white/6 rounded-2xl transition-all duration-300 focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-blue-400 hover:border-gray-300 dark:hover:border-white/8 outline-hidden text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400",
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <input
                          ...
                          maxLength={19}
                          className={cn(
                            "w-full h-14 px-6 pr-20 text-lg bg-gray-50/80 dark:bg-white/3 border-2 border-gray-200/60 dark:border-white/6 rounded-2xl transition-all duration-300 focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 dark:focus:border-blue-400 hover:border-gray-300 dark:hover:border-white/8 outline-hidden text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400",
          ...
          <div className="xl:col-span-1">
            <div className="sticky top-8 space-y-6">
              ...
              >
                <div className="bg-white/95 dark:bg-white/5 backdrop-blur-xl rounded-3xl border border-white/20 dark:border-white/4 p-8 shadow-2xl">
                  <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div
                        key={index}
                        className="group p-4 rounded-2xl bg-gray-50/80 dark:bg-white/3 hover:bg-white/80 dark:hover:bg-white/6 transition-all duration-300 hover:scale-105 border border-gray-200/30 dark:border-white/4"
                      >
                        <div className="flex items-start gap-4">
                          <div
                            className={cn(
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200/50 dark:border-white/6">
