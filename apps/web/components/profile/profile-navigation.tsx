...
export function ProfileNavigation({ activeTab = "about", onTabChange }: ProfileNavigationProps) {
  ...
  return (
    <div className="sticky top-0 z-nav bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-md rounded-t-2xl shadow-xs border-b border-gray-200 dark:border-white/6 mb-4">
      <nav
        ...
        {tabs.map((tab) => {
          ...
          const tabButtonClass = cn(
            ...
            isActive
              ...
              : "bg-transparent text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/5 border border-transparent"
          );
          return (
            <button
              key={tab.id}
