...
const MODAL_CONTAINER_CLASS =
	"bg-white dark:bg-white/[0.03] rounded-xl shadow-lg p-6 w-full max-w-md relative border border-gray-200 dark:border-white/[0.06] mx-4";
...
const DROPDOWN_BUTTON_CLASS =
	"relative w-full px-4 py-2.5 bg-gray-50 dark:bg-white/[0.03] border border-gray-300 dark:border-white/[0.06] rounded-lg text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 transition-all hover:bg-gray-100 dark:hover:bg-white/[0.03] hover:border-gray-400 dark:hover:border-white/[0.06] disabled:opacity-50 disabled:cursor-not-allowed";
const DROPDOWN_MENU_CLASS =
	"absolute left-0 right-0 mt-2 bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-white/[0.06] rounded-lg shadow-lg overflow-hidden z-10";
const INPUT_CLASS =
	"block w-full rounded-lg border border-gray-300 dark:border-white/[0.06] bg-gray-50 dark:bg-white/[0.05] text-gray-900 dark:text-gray-100 px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent transition";
									...
									<div className="p-1">
										{REASON_OPTIONS.map((option) => (
											<button
												key={option.value}
												type="button"
												className="relative flex items-center justify-between w-full px-3 py-2 text-sm text-gray-900 dark:text-gray-100 rounded-md cursor-pointer outline-none transition-colors hover:bg-gray-100 dark:hover:bg-white/[0.06]"
												onClick={() => {
