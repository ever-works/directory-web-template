...
export function CacheStatus({
  ...
  const getStatusColor = () => {
    ...
    return 'text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-[#0a0a0a]/20 border-slate-200 dark:border-white/[0.06]/50';
  };
  ...
  return (
    <div className="bg-white dark:bg-white/[0.05] border border-slate-200 dark:border-white/[0.06] rounded-xl p-6 shadow-xs mb-6">
      ...
      {/* Performance Metrics */}
      <div className="bg-linear-to-r from-slate-50 to-theme-primary-50 dark:from-white/[0.06]/50 dark:to-theme-primary-900/20 rounded-lg p-4 border border-slate-200 dark:border-white/[0.06] mb-6">
      ...
      {/* Last Updated Info */}
      {lastUpdated && (
        <div className="bg-slate-50 dark:bg-white/[0.04] rounded-lg p-4 border border-slate-200 dark:border-white/[0.06] mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <button
          ...
          className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-white/[0.04] border border-slate-300 dark:border-white/[0.06] rounded-lg hover:bg-slate-200 dark:hover:bg-white/[0.06] hover:border-slate-400 dark:hover:border-white/[0.08] transition-colors"
        >
