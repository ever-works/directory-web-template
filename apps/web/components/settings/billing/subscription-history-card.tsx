	...
	switch (status.toLowerCase()) {
		...
		default:
			return {
				...
				bgColor: 'bg-slate-50 dark:bg-white/[0.04]',
				borderColor: 'border-slate-200 dark:border-white/[0.1]',
				icon: Clock,
			...
			<div className="flex items-start justify-between">
					...
					<div className="flex items-center gap-4 mb-4">
						...
						<div className="flex-1">
							...
							<div className="flex items-center gap-3">
								<span
									className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium border ${statusConfig.bgColor} ${statusConfig.color} ${statusConfig.borderColor} dark:border-white/[0.1]`}
								>
									<StatusIcon className="w-3 h-3" />
									{statusConfig.label}
								</span>

								<span className="inline-flex items-center gap-1 px-2 py-1 bg-slate-100 dark:bg-white/[0.04] text-slate-600 dark:text-slate-300 text-xs font-medium rounded-full">
				...
				<div className="text-right ml-6">
					...
					<div className="flex flex-col gap-2">
						<button className="inline-flex items-center gap-2 px-3 py-2 text-xs font-medium text-slate-600 bg-slate-100 dark:bg-white/[0.04] rounded-lg hover:bg-slate-200 transition-colors dark:text-slate-300">
			...
			<div className="mt-4 pt-4 border-t border-slate-200 dark:border-white/[0.06]">
				<div className="flex items-center justify-between text-sm">
					<div className="flex items-center gap-4 text-slate-600 dark:text-slate-300">
						...
						<code className="bg-slate-100 dark:bg-white/[0.04] px-2 py-1 rounded-sm text-xs font-mono">
