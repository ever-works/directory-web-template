...
export function SidebarSponsor({
	...
	return (
		<div
			className={cn(
				'bg-white/95 dark:bg-[#141414]/95 rounded-2xl p-6 border border-gray-200/50 dark:border-white/6 backdrop-blur-xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1',
				className
			)}
		>
			{/* Header */}
				...
				<div className="p-4 bg-gradient-to-br from-blue-50/80 to-indigo-50/80 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl hover:from-blue-100/80 hover:to-indigo-100/80 dark:hover:from-blue-900/30 dark:hover:to-indigo-900/30 transition-all duration-300 border border-blue-100 dark:border-blue-800/30">
					<div className="flex items-start gap-4">
						...
						<div className="relative shrink-0">
							<div className="w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-300 bg-white dark:bg-white/5 border border-blue-200/50 dark:border-blue-700/30 shadow-sm group-hover:shadow-md group-hover:scale-105">
