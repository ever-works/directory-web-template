...
const CARD_WRAPPER = "border-0 shadow-lg bg-white dark:bg-white/[0.03]";
const CARD_HEADER = "px-6 py-4 border-b border-gray-100 dark:border-white/[0.06]";
const CARD_BODY = "p-6";
...
const PRICING_CARD_UNSELECTED = "border-gray-200 dark:border-white/[0.06] hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-md";
const SUMMARY_BOX = "rounded-xl bg-gray-50 dark:bg-white/[0.03] p-5";
