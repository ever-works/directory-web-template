			...
			>
				...
				<div className={MODAL_HEADER}>
					...
					<button
						...
						className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-white/6 transition-colors disabled:opacity-50"
					>
					...
					{isLoading ? (
						...
						<div className="space-y-6">
							...
							<div>
								...
								<div className="space-y-1 divide-y divide-gray-100 dark:divide-white/6">
							...
							{showReasonSection && (
								<div>
									...
									{sponsorAd.status === 'cancelled' && sponsorAd.cancelReason && (
										<div className="p-4 bg-gray-50 dark:bg-white/5 rounded-lg border border-gray-200 dark:border-white/6">
...
function ModalSkeleton() {
	return (
		<div className="space-y-6 animate-pulse">
			<div className="flex justify-center">
				<div className="h-8 w-32 bg-gray-200 dark:bg-white/8 rounded-full" />
			</div>
			<div>
				<div className="h-4 w-32 bg-gray-200 dark:bg-white/8 rounded mb-2" />
				<div className="p-4 bg-gray-50 dark:bg-white/5 rounded-lg">
					<div className="flex items-start gap-3">
			...
			<div>
				<div className="h-4 w-40 bg-gray-200 dark:bg-white/8 rounded mb-2" />
			...
			<div>
				<div className="h-4 w-36 bg-gray-200 dark:bg-white/8 rounded mb-2" />
				<div className="space-y-3">
					<div className="h-10 bg-gray-100 dark:bg-white/5 rounded" />
					<div className="h-10 bg-gray-100 dark:bg-white/5 rounded" />
				</div>
