...
export function SponsorshipItem({
	...
	return (
		<div className="p-4 bg-white dark:bg-white/[0.03] rounded-lg border border-gray-200 dark:border-white/[0.06] hover:border-gray-300 dark:hover:border-white/[0.06] transition-colors">
			...
			{/* Action Buttons */}
			{hasActions && (
				<div className="mt-4 pt-3 border-t border-gray-100 dark:border-white/[0.06] flex flex-wrap items-center gap-2">
					{canPayNow && onPayNow && (
						<Button
							size="sm"
							color="success"
			...
			{sponsorAd.status === 'cancelled' && sponsorAd.cancelReason && (
				<div className="mt-3 p-3 bg-gray-50 dark:bg-white/[0.05] rounded-lg border border-gray-200 dark:border-white/[0.06]">
...
export function SponsorshipItemSkeleton() {
	return (
		<div className="p-4 bg-white dark:bg-white/[0.03] rounded-lg border border-gray-200 dark:border-white/[0.06] animate-pulse">
			<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
