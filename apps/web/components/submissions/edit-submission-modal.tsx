...
const CLASSES = {
  ...
  input: "w-full px-4 py-2.5 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/6 rounded-lg text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-theme-primary-500 focus:border-transparent transition-all duration-200",
  textarea: "w-full px-4 py-2.5 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/6 rounded-lg text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-theme-primary-500 focus:border-transparent transition-all duration-200 resize-none",
                ...
                <div className="flex flex-wrap gap-2">
                  {submission.tags.length > 0 ? (
                    submission.tags.map((tag) => (
                      <span
                        key={tag}
                        className="inline-flex items-center px-3 py-1 bg-gray-100 dark:bg-white/5 text-gray-700 dark:text-gray-300 rounded-full text-sm border border-gray-200 dark:border-white/6"
                      >
                        {tag}
                      </span>
                    ))
