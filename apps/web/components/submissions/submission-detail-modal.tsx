...
const CLASSES = {
  ...
  tag: "inline-flex items-center px-3 py-1 bg-gray-100 dark:bg-white/5 text-gray-700 dark:text-gray-300 rounded-full text-sm border border-gray-200 dark:border-white/6",
  statsCard: "p-4 bg-gray-50 dark:bg-white/3 rounded-lg text-center",
