...
export function SubmissionItem({
  ...
  return (
    <div className={`group p-6 border border-gray-200 dark:border-white/6 rounded-xl hover:border-theme-primary-300 dark:hover:border-theme-primary-600 hover:shadow-lg hover:shadow-theme-primary-500/10 transition-all duration-300 bg-white/50 dark:bg-white/3 backdrop-blur-xs ${isDisabled ? 'opacity-60 pointer-events-none' : ''}`}>
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {submission.tags.slice(0, 5).map((tag) => (
                  <span
                    key={tag}
                    className="inline-flex items-center px-3 py-1 bg-gray-100 dark:bg-white/5 text-gray-700 dark:text-gray-300 rounded-full text-xs font-medium border border-gray-200 dark:border-white/6"
                  >
                    {tag}
                  </span>
                ))}
                {submission.tags.length > 5 && (
                  <span className="inline-flex items-center px-3 py-1 bg-gray-100 dark:bg-white/5 text-gray-500 dark:text-gray-400 rounded-full text-xs font-medium border border-gray-200 dark:border-white/6">
      ...
      <div className="flex items-start gap-4">
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <div className="h-6 w-48 bg-gray-200 dark:bg-white/8 rounded" />
                <div className="h-6 w-24 bg-gray-200 dark:bg-white/8 rounded-full" />
              </div>
              ...
              <div className="flex gap-6">
                <div className="h-4 w-24 bg-gray-200 dark:bg-white/8 rounded" />
                <div className="h-4 w-32 bg-gray-200 dark:bg-white/8 rounded" />
              </div>
            </div>
            <div className="flex items-center gap-2 ml-4">
              <div className="h-8 w-8 bg-gray-200 dark:bg-white/8 rounded-lg" />
              <div className="h-8 w-8 bg-gray-200 dark:bg-white/8 rounded-lg" />
              <div className="h-8 w-8 bg-gray-200 dark:bg-white/8 rounded-lg" />
            </div>
          </div>
