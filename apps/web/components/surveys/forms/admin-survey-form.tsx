		...
		<form onSubmit={handleSubmit} className="p-6 space-y-6">
			...
			<div>
				...
				<input
					...
					className="w-full px-4 py-2 border border-gray-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-white/[0.05] focus:ring-2 focus:ring-blue-500 focus:border-transparent"
			...
			<div>
				...
				<textarea
					...
					className="w-full px-4 py-2 border border-gray-300 dark:border-white/[0.08] rounded-lg bg-white dark:bg-white/[0.05] focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
					rows={3}
			...
			<div>
				...
				<textarea
					...
					className={`w-full px-4 py-2 border rounded-lg bg-white dark:bg-white/[0.05] focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none font-mono text-sm ${jsonError ? 'border-red-500' : 'border-gray-300 dark:border-white/[0.08]'
						}`}
					rows={12}
			...
			{/* Actions */}
			<div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-white/[0.06]">
				<Button
					type="button"
					variant="outline"
					onClick={onCancel}
