			...
			<ModalBody className="space-y-4">
				<div>
					...
					<input
						...
						className="w-full px-4 py-2 border border-gray-300 dark:border-white/8 rounded-lg bg-white dark:bg-white/5 focus:ring-2 focus:ring-green-500 focus:border-transparent"
