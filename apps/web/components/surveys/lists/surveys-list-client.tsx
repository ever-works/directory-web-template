			...
			<div className="overflow-x-auto">
				<table className="w-full">
					...
					<tbody className="divide-y divide-gray-200 dark:divide-white/[0.06]">
						{surveys.map((survey) => (
							<tr key={survey.id} className="hover:bg-gray-50 dark:hover:bg-white/[0.03]">
								...
								<td className="px-6 py-4">
									...
									<button
										...
										className="p-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/[0.06] rounded-sm transition-colors"
