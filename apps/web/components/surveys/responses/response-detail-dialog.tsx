                ...
                <div className="flex items-start justify-between w-full">
                    ...
                    <div className="flex items-center gap-2 ml-4">
                        <input
                            ...
                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-white/[0.08] dark:border-white/[0.08]"
                        />
                        <label
