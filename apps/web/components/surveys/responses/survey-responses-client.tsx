...
export function SurveyResponsesClient({
	...
	return (
		<div className="container mx-auto px-4 py-8">
			...
			{/* Filters */}
			<div className="mb-6 bg-white dark:bg-white/5 rounded-lg shadow-xs p-4">
				<div className="flex items-center gap-4">
					...
					<div className="flex items-center gap-2">
						...
						<input
							...
							className="px-2 py-1 border border-gray-300 dark:border-white/8 rounded-sm text-sm bg-white dark:bg-white/3"
						/>
					</div>
					<div className="flex items-center gap-2">
						...
						<table className="w-full">
							...
							<tbody className="divide-y divide-gray-200 dark:divide-white/6">
								{responses.map((response) => (
									<tr key={response.id} className="hover:bg-gray-50 dark:hover:bg-white/3">
