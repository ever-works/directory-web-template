    ...
    <Button
      className={cn(
        ...
        "hover:transform-none active:transform-none",
        {
          ...
          "bg-transparent text-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/[0.06]":
            !isActive && !isAlltags,
        }
      )}
      radius="md"
    ...
    return (
      <>
            ...
            <AccordionItem
              ...
              title={
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="bg-theme-primary-100 dark:bg-white/[0.05] text-theme-primary-700 dark:text-gray-300 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full text-xs font-bold border border-theme-primary-200 dark:border-white/[0.06]">
                    {props.total}
                  </span>
                </div>
              }
        ...
        <div className="hidden md:flex flex-col w-full max-w-[280px] lg:max-w-64 gap-4 lg:gap-6">
          ...
          {/* Categories Section */}
          <div className="bg-white/90 dark:bg-white/[0.03] backdrop-blur-xs rounded-xl border border-gray-200 dark:border-white/[0.06] overflow-hidden shadow-xs dark:shadow-lg transition-colors duration-300">
            <div className="p-3 lg:p-4 border-b border-gray-200/50 dark:border-white/[0.06]">
          ...
          {(searchTerm || selectedTags.length > 0 || sortBy !== "popularity") && (
            <div className="bg-white/90 dark:bg-white/[0.03] backdrop-blur-xs rounded-xl border border-gray-200/50 dark:border-white/[0.06] overflow-hidden shadow-xs dark:shadow-lg transition-colors duration-300">
              <div className="p-3 lg:p-4 border-b border-gray-200/50 dark:border-white/[0.06] flex items-center justify-between">
                <h2 className="text-base lg:text-lg font-semibold text-gray-900 dark:text-gray-200 transition-colors duration-300">
                  Active Filters
                </h2>
                <Button
              ...
              <div className="p-3 lg:p-4 space-y-2 lg:space-y-3">
                {searchTerm && (
                  <div className="flex items-center gap-1.5 lg:gap-2">
                    ...
                    <span className="inline-flex items-center px-2 lg:px-3 py-0.5 lg:py-1 rounded-lg bg-theme-primary-100 dark:bg-white/[0.05] text-theme-primary-700 dark:text-theme-primary-400 text-xs lg:text-sm font-medium border border-theme-primary-200 dark:border-white/[0.06]">
                      {searchTerm}
                      <button
                    ...
                    <div className="flex flex-wrap gap-1.5 lg:gap-2">
                      {selectedTags.map((tagId) => {
                        ...
                        return tag ? (
                          <span
                            key={tagId}
                            className="inline-flex items-center px-2 lg:px-3 py-0.5 lg:py-1 rounded-lg bg-theme-primary-100 dark:bg-white/[0.05] text-theme-primary-700 dark:text-theme-primary-400 text-xs lg:text-sm font-medium border border-theme-primary-200 dark:border-white/[0.06]"
                          >
                            {tag.name}
                            <button
                ...
                {sortBy !== "popularity" && (
                  <div className="flex items-center gap-1.5 lg:gap-2">
                    ...
                    <span className="inline-flex items-center px-2 lg:px-3 py-0.5 lg:py-1 rounded-lg bg-green-100 dark:bg-white/[0.05] text-green-700 dark:text-green-400 text-xs lg:text-sm font-medium border border-green-200 dark:border-white/[0.06]">
                      {sortBy === "name-asc"
                        ? "Name (A-Z)"
                        : sortBy === "name-desc"
                          ? "Name (Z-A)"
          ...
          {/* Sort By Section */}
          <div className="bg-white/90 dark:bg-white/[0.03] backdrop-blur-xs rounded-xl border border-gray-200 dark:border-white/[0.06] overflow-hidden shadow-xs dark:shadow-lg transition-colors duration-300">
            <div className="p-3 lg:p-4 border-b border-gray-200 dark:border-white/[0.06]">
