  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      <div className="relative mb-8">
        <div className="absolute top-3.5 left-0 w-full h-0.5 bg-gray-200 dark:bg-white/8">
          <div
                ...
                <div
                  className={cn(
                    "w-8 h-8 rounded-full border-2 flex items-center justify-center text-sm font-medium transition-all duration-200",
                    {
                      ...
                      "bg-white dark:bg-[#121212] border-blue-600 text-blue-600": isCurrent && !isCompleted,
                      "bg-white dark:bg-[#121212] border-gray-300 dark:border-white/8 text-gray-400 dark:text-gray-500": !isCurrent && !isCompleted,
