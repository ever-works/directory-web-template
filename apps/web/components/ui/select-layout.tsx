							...
							<button
								...
								className={cn(
									...
									isActive
										...
										: 'bg-white/80 dark:bg-white/[0.04] border-gray-200/50 dark:border-white/[0.06] hover:border-theme-primary-300 dark:hover:border-theme-primary-600 hover:shadow-md',
