    ...
    return (
      <div className={`bg-[#141414]/3 dark:bg-white/4 rounded-lg border border-gray-200 dark:border-white/6 p-4 shadow-xs hover:shadow-md transition-all duration-200 ${className}`}>
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                <code className="px-2 py-1 bg-gray-100 dark:bg-white/8 rounded-sm text-xs font-mono text-gray-800 dark:text-gray-200 border">
                  {versionInfo.commit}
                </code>
            ...
            {versionInfo.message && (
              <div className="text-xs text-gray-500 dark:text-gray-400 italic bg-gray-50 dark:bg-white/4 p-2 rounded-sm border-l-2 border-blue-200 dark:border-blue-800">
          ...
          {/* Details section */}
          {showDetails && (
            <div className="pt-3 border-t border-gray-200 dark:border-white/6 space-y-2">
              ...
              <div className="text-xs text-gray-500 dark:text-gray-400">
                ...
                <code className="text-xs bg-gray-100 dark:bg-white/8 px-1 py-0.5 rounded-sm font-mono">
