      ...
      {isVisible && (
        ...
        >
          <div className="bg-white dark:bg-white/3 border border-gray-200 dark:border-white/6 rounded-xl shadow-xl p-4 min-w-72 max-w-80 backdrop-blur-xs">
            ...
            {/* Header */}
            <div className="flex items-center justify-between mb-3 pb-2 border-b border-gray-100 dark:border-white/6">
            ...
            {/* Footer */}
            <div className="mt-3 pt-2 border-t border-gray-100 dark:border-white/6">
