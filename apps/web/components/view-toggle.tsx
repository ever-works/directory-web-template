...
export default function ViewToggle({
  ...
  return (
	<div className="relative flex items-center gap-1 justify-end">
	  <div className="relative bg-white/90 dark:bg-white/[0.04] backdrop-blur-xs rounded-lg p-1 flex items-center shadow-md dark:shadow-lg border border-gray-200/50 dark:border-white/[0.06] transition-all duration-300 hover:shadow-lg dark:hover:shadow-xl">
		<button
		  className={`relative ${
