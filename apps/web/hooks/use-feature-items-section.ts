...
export function useFeaturedItemsSection({ limit = 6, enabled = true }: UseFeaturedItemsSectionProps = {}) {
	const { featuredItems, isLoading, error, refetch } = useFeaturedItems({ enabled });
