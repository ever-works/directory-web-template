...
export function LemonSqueezyPaymentForm({ checkoutUrl }: LemonSqueezyPaymentFormProps) {
	return (
		<div className="w-full h-[600px] flex items-center justify-center bg-gray-50 dark:bg-white/3 rounded-lg overflow-hidden">
			<iframe
				src={checkoutUrl}
				className="w-full h-full border-0 dark:bg-white/3"
