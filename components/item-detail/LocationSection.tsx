...
const sectionCardStyles =
	'bg-white/95 dark:bg-gray-900/95 rounded-2xl p-8 border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1';
...
const remoteBadgeStyles =
	'inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold border bg-linear-to-r from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-700/50';
