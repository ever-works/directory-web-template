      ...
      <DropdownMenu.Root modal={false} open={open} onOpenChange={setOpen}>
        ...
        <DropdownMenu.Portal>
          <DropdownMenu.Content
            ...
            align="end"
            className={cn(
              "z-50 min-w-(--radix-dropdown-menu-trigger-width) bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg shadow-black/10 dark:shadow-black/30 overflow-hidden animate-in fade-in-0 zoom-in-95 duration-200",
            )}
          >
            <div className="p-1">
            <DropdownMenu.Item
              className="relative flex items-center gap-1 px-3 py-2 text-gray-900 dark:text-gray-100 rounded-md cursor-pointer outline-none transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-800"
            ...
            >
              ...
              <span className="font-medium text-sm">{t("COPY_LINK")}</span>
            </DropdownMenu.Item>
            ...
            >
              ...
              <span className="font-medium text-sm mt-1">X</span>
            </DropdownMenu.Item>
