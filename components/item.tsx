...
const TAG_BUTTON_BASE_CLASS =
	'text-xs transition-all duration-300 cursor-pointer text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 hover:scale-105 font-medium px-1 py-0.5 rounded-md hover:bg-blue-50 dark:hover:bg-blue-900/20 whitespace-nowrap';
...
export default function Item(props: ItemProps) {
	...
	// Title styling: for grid/classic layouts, reserve space for 3 lines, truncate if longer, and vertically center
	const titleClassName = cn(
		...
		isGridOrClassicLayout && 'line-clamp-3 min-h-[3.75em] flex items-center'
	);
