...
const getLayoutMap = (isDark: boolean, t: any) =>
  ({
    ...
    //   preview: (
    //     <div className="w-full h-32 bg-linear-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950 dark:to-emerald-900 rounded-xl overflow-hidden border-2 border-emerald-300 dark:border-emerald-600 relative group shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          return (
            <button
              ...
              className={`relative w-full p-6 rounded-2xl transition-all duration-500 transform hover:scale-[1.01] ${
                isActive
                  ? "bg-linear-to-br from-theme-primary-50/50 via-white to-theme-primary-100/30 dark:from-gray-800 dark:via-gray-900 dark:to-theme-primary-950/30 border-2 border-theme-primary-400/50 dark:border-theme-primary-500/50 shadow-xl shadow-theme-primary-200/30 dark:shadow-theme-primary-900/20"
                  : "bg-white/80 dark:bg-gray-800/80 backdrop-blur-xs border border-gray-200/50 dark:border-gray-700/50 hover:border-theme-primary-300 dark:hover:border-theme-primary-600 shadow-md hover:shadow-xl"
              }`}
            ...
            >
              ...
              <div className="relative space-y-5">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`relative p-3 rounded-2xl transition-all duration-300 ${
                        isActive
                          ...
                          : "bg-linear-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 group-hover:from-theme-primary-100 group-hover:to-theme-primary-200 dark:group-hover:from-theme-primary-900/30 dark:group-hover:to-theme-primary-800/30"
                      }`}
                    >
                      <div
                        className={
                  ...
                  {isActive && (
                    <div className="flex items-center gap-2 px-4 py-2 bg-linear-to-r from-theme-primary-500 to-theme-primary-600 text-white rounded-full text-xs font-semibold shadow-lg animate-pulse">
                      <svg
                        className="w-3 h-3"
                        fill="currentColor"
                        viewBox="0 0 20 20"
