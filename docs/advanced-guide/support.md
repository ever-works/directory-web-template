...
- **📚 [Documentation](https://docs.ever.works)** - Complete documentation
...
#### Runtime Issues
- **API Connection**: Check your `NEXT_PUBLIC_API_BASE_URL` environment variable
- **Authentication**: Verify your OAuth provider credentials
...
- **🎨 [Feature Requests](https://github.com/ever-works/ever-works-website-template/issues)** - Submit your ideas
- **💡 [Roadmap](https://github.com/ever-works/ever-works-website-template/projects)** - See what's planned
- **🤝 [Contributing Guide](https://github.com/ever-works/ever-works-website-template/blob/main/CONTRIBUTING.md)** - Help us build the template
