...
The Categories API provides a lightweight public endpoint for checking whether categories exist in the system. Categories are derived from the content layer (Git-based CMS) rather than a database, making this endpoint available even without a database connection.

**Source file:** `template/app/api/categories/exists/route.ts`

## Endpoint Summary

| Method | Path | Auth | Description |
|--------|------|------|-------------|
| GET | `/api/categories/exists` | None | Check if categories exist |
