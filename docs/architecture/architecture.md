...
For a full directory walkthrough, see the [Project Structure](/architecture/project-structure) page.
...
For a deeper look at the data flow between these layers, see [Data Flow](/architecture/data-flow).
...
See [Routing](/architecture/routing) for the full route map.
...
For details on the guard system and role-based permissions, see [Guards System](/architecture/guards-system) and [Permissions System](/architecture/permissions-system).
...
See [Repository Patterns](/architecture/repository-patterns) for how the data access layer is structured.
...
For a detailed breakdown, see [Middleware](/architecture/middleware) and [Middleware Deep Dive](/architecture/middleware-deep-dive).
...
| Page | What It Covers |
|---|---|
| [Tech Stack](/architecture/tech-stack) | Full dependency inventory and version details |
| [Project Structure](/architecture/project-structure) | Directory-by-directory walkthrough |
| [Data Flow](/architecture/data-flow) | Request lifecycle from browser to database |
| [Routing](/architecture/routing) | App Router structure and URL patterns |
| [Component Patterns](/architecture/component-patterns) | Server vs. client components, composition patterns |
| [State Management](/architecture/state-management) | React Query, Zustand, and server state |
| [API Layer](/architecture/api-layer) | REST API design and route handler patterns |
| [Middleware](/architecture/middleware) | Middleware pipeline and request processing |
| [Guards System](/architecture/guards-system) | Role-based access control at the route level |
| [Permissions System](/architecture/permissions-system) | Fine-grained permission definitions |
| [Repository Patterns](/architecture/repository-patterns) | Data access layer conventions |
| [Validation Patterns](/architecture/validation-patterns) | Zod schemas and input validation |
| [Theme System](/architecture/theme-system) | Theming architecture and color management |
| [Color System](/architecture/color-system) | Dynamic color generation pipeline |
| [SEO System](/architecture/seo-system) | Metadata, sitemaps, and structured data |
| [Payment Library](/architecture/payment-library) | Multi-provider payment integration |
| [Content Library](/architecture/content-library) | Git-based CMS content pipeline |
| [Editor System](/architecture/editor-system) | Tiptap rich-text editor integration |
| [Mapper Patterns](/architecture/mapper-patterns) | Data transformation between layers |
| [Error Boundaries](/architecture/error-boundaries) | Error handling and recovery |
| [Analytics Layer](/architecture/analytics-layer) | Event tracking and analytics pipeline |
| [Swagger System](/architecture/swagger-system) | OpenAPI documentation generation |

## Where to Go Next

- **New to the project?** Start with [Getting Started](/getting-started) to install and run the template.
- **Ready to customize?** Jump to the [Guides](/guides) section for step-by-step tutorials.
- **Want the full tech inventory?** See [Tech Stack](/architecture/tech-stack).
