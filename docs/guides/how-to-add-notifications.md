...
| Not cleaning up old notifications | Set up the cleanup cron job (see [How to Add a Cron Job](/template/guides/how-to-add-a-cron-job)) |

---

## Related Pages

- [Email Templates](/template/guides/email-templates) -- creating and customizing email templates
- [How to Add a Service](/template/guides/how-to-add-a-service) -- service architecture patterns
- [How to Add a Webhook](/template/guides/how-to-add-a-webhook) -- triggering notifications from webhook events
- [How to Add a Cron Job](/template/guides/how-to-add-a-cron-job) -- scheduling periodic notification cleanups
- [Admin Dashboard](/template/guides/admin-dashboard) -- where in-app notifications are displayed
