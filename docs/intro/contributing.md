...
See the [Plugin System documentation](/platform/plugin-system) for architecture details.

## License

- **Ever Works Platform** and **Ever Works Website Template** are licensed under the **GNU Affero General Public License v3.0 (AGPL-3.0)**.
