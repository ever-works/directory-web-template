...
2. **Contribute code.** Pull requests that implement requested features are the fastest path from idea to reality. See the [Contributing Guide](/docs/contributing) for details.
...
See the [Changelog & Versioning](/docs/changelog) page for details on versioning strategy and upgrade paths.
