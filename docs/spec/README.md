...
| 029 | [`client-submissions-redesign`](029-client-submissions-redesign/spec.md) | proposed | UI-only redesign of `/client/submissions`: responsive table-on-desktop / cards-on-mobile, polished KPI stats cards, status segmented tabs + sort UX, dedicated empty / filtered-empty / error / skeleton states, reuses existing design-system primitives — no functional changes |
