...
UPDATE "item_location_index" SET "city_normalized" = lower(trim("city")) WHERE "city" IS NOT NULL;--> statement-breakpoint
UPDATE "item_location_index" SET "country_normalized" = lower(trim("country")) WHERE "country" IS NOT NULL;--> statement-breakpoint
