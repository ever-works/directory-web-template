...
export class EmailService {
	...
	async sendAccountCreatedEmail(userName: string, userEmail: string, companyName?: string): Promise<any> {
		this.ensureAvailable();
	...
	async sendVerificationEmailWithTemplate(email: string, token: string, userName?: string): Promise<any> {
		this.ensureAvailable();
	...
	async sendInvitationEmail(
		...
		this.ensureAvailable();
		const { getInvitationEmailTemplate } = await import('./templates');
...
export const sendVerificationEmail = async (email: string, token: string) => {
	return tryEmailOperation((service) => service.sendVerificationEmail(email, token), 'sendVerificationEmail');
};

export const sendPasswordResetEmail = async (email: string, token: string) => {
	return tryEmailOperation((service) => service.sendPasswordResetEmail(email, token), 'sendPasswordResetEmail');
};
...
export const sendTwoFactorTokenEmail = async (email: string, token: string) => {
	return tryEmailOperation((service) => service.sendTwoFactorTokenEmail(email, token), 'sendTwoFactorTokenEmail');
};
...
export const sendAccountCreatedEmail = async (userName: string, userEmail: string, companyName?: string) => {
	return tryEmailOperation(
...
export const sendVerificationEmailWithTemplate = async (email: string, token: string, userName?: string) => {
	return tryEmailOperation(
...
export const sendInvitationEmail = async (
	...
	return tryEmailOperation(
		(service) => service.sendInvitationEmail(email, inviterName, organizationName, invitationLink),
		'sendInvitationEmail'
	);
};
