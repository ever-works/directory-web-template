...
class MapboxAutocompleteInstance implements IAutocompleteInstance {
	...
	private setupAutocomplete(): void {
		...
		this.dropdown.className =
			'absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg max-h-60 overflow-auto hidden';
	...
	private showSuggestions(
		...
		features.forEach((feature) => {
			...
			item.type = 'button';
			item.className =
				'w-full px-4 py-2 text-left hover:bg-gray-100 dark:hover:bg-gray-700 text-sm';
