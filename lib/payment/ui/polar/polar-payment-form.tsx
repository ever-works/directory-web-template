	...
	<div className="w-full h-full p-8 space-y-8 animate-pulse">
		<div className="flex items-center justify-between">
			<div className="space-y-2">
				...
				<div className="h-6 w-48 bg-gray-300 dark:bg-gray-600 rounded-lg" />
			</div>
...
export function PolarPaymentForm({ checkoutUrl, onSuccess, onError, theme = 'light', onClose }: PolarPaymentFormProps) {
	...
	return (
		<div className="relative w-full h-[650px] overflow-hidden rounded-2xl bg-white dark:bg-[#0B0F1A] border border-gray-200/50 dark:border-gray-800/50 shadow-2xl transition-all duration-500">
