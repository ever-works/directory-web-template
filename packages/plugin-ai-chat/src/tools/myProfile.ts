...
export const myProfileTool: ChatTool<MyProfileInput, UserProfileSummary | AuthRequiredResult | null> = {
	name: 'myProfile',
	description:
	...
	execute: async (_input, ctx) => {
		if (!ctx.session) {
			return authRequired('my-profile', 'Sign in to see your directory profile.');
		}
